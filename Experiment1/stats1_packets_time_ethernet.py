...
df = pd.read_csv(r"Data\data_youtube_ethernet.csv", delimiter=',')
...
for x in range(start,end):
    ...
    elif list_source.iloc[x]=="66.130.90.141":
...
plt.savefig('exp1_packet_time_hist_ethernet.eps', format='eps')
plt.show()
